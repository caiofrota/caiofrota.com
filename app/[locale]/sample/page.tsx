 ...
 * Now with: system-aware theme, smooth in-page scroll, scroll-to-top,
...
const I18N = {
  en: {
    ...
    hero: {
      ...
      subtitle: "Web applications, backend services and cloud platforms built with purpose, clarity and real reliability.",
      ctaPrimary: "See projects",
      ctaSecondary: "Contact me",
      availability: "Open to collaborations",
      badge: "Senior Software Engineer & Tech Lead",
    },
    about: {
      kicker: "Who am I",
      ...
      cards: [
        {
          ...
          text: "Scalable services, resilient pipelines, clear contracts and observability that prevents 3AM firefights.",
        },
        {
          title: "Product & UX",
    ...
    portfolio: {
      ...
      subtitle: "From enterprise platforms to creative experiences. Highlights:",
    ...
    cta: {
      title: "1:1 Mentoring",
      blurb: "Support for developers growing into backend, architecture and technical leadership.",
      button: "Book a chat",
    },
    contact: {
      kicker: "Shall we build?",
      title: "Contact",
      subtitle: "Partnerships, consulting, digital products, backend challenges — or just say hi.",
    },
    form: {
      name: "Your name",
      email: "Email",
  ...
  pt: {
    ...
    hero: {
      ...
      subtitle: "Aplicações web, serviços backend e plataformas cloud construídos com propósito, clareza e confiabilidade real.",
      ctaPrimary: "Ver projetos",
      ctaSecondary: "Falar comigo",
      availability: "Disponível para colaborações",
      badge: "Engenheiro de Software Sênior & Tech Lead",
    },
    about: {
      kicker: "Quem sou eu",
      ...
      cards: [
        {
          title: "Backend, APIs & Arquitetura",
          text: "Serviços escaláveis, pipelines resilientes, contratos claros e observabilidade que evita pagodes às 3AM.",
        },
        {
          title: "Produtos & UX",
    ...
    portfolio: {
      ...
      subtitle: "De plataformas empresariais a experiências criativas. Destaques:",
    ...
    cta: {
      title: "Mentorias 1:1",
      blurb: "Apoio para devs evoluindo em backend, arquitetura e liderança técnica.",
      button: "Agendar conversa",
    },
    contact: {
      kicker: "Vamos construir?",
      title: "Contato",
      subtitle: "Parcerias, consultorias, produtos digitais, desafios de backend — ou apenas um oi.",
    },
    form: {
      name: "Seu nome",
      email: "E-mail",
...
const projects = [
  ...
  },
  {
    ...
    blurb: "Clinical integrations with FHIR/HL7, backed by testing, observability and sustainable engineering practices.",
    tags: ["Node.js", "FHIR", "HL7", "Mirth Connect"],
  },
];
      ...
      <div className="grid gap-6 md:grid-cols-2">
        {projects.map((p) => (
          ...
          >
            ...
            <div
              className={`pointer-events-none absolute -bottom-28 -right-20 h-64 w-64 rounded-full bg-linear-to-tr opacity-25 blur-3xl ${TOKENS.accent}`}
            />
          </motion.article>
        ))}
      </div>
              ...
              return (
                ...
                >
                  <span className="inline-flex items-center gap-3">
                    <Icon className="h-4 w-4 opacity-80" /> {social.label}
                  </span>
